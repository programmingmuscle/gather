                ...
                <form method="POST" action="{{ route('posts.update', ['id' => $post->id]) }}">
                    ...
                    <div>
                        <div class="form-group d-inline-block">
                            ...
                            @endif
                            {!! Form::selectRange('year', date('Y'), date('Y')+1, $postDateTimeArray[0], ['class' => 'form-control d-inline-block w-auto']) !!}年
                        </div>
                        <div class="form-group d-inline-block">
                            @if ($errors->has('month'))
                    ...
                    <div>
                        ...
                        <div class="form-group d-inline-block">
                            ...
                            $postDateTimeArray[4],['class' => 'form-control d-inline-block w-auto']) !!}分から
                        </div>
                    </div>
                    <div class="form-group d-inline-block">
                    ...
                    <div>
                        <div class="form-group d-inline-block">
                            ...
                            @endif
                            {!! Form::selectRange('deadlineYear', date('Y'), date('Y')+1, $postDeadlineArray[0], ['class' => 'form-control d-inline-block w-auto']) !!}年
                        </div>
                        <div class="form-group d-inline-block">
                    ...
                    <div class="form-group d-inline-block">
                        ...
                        $postDeadlineArray[4], ['class' => 'form-control d-inline-block w-auto']) !!}分
                    </div>
                    <div class="form-group">
                        ...
                        $post->people, ['class' => 'form-control']) !!}
                    </div>
                    <div class="form-group">
