@if (($post->people > $post->participate_users()->count()) && (date('Y/n/d G:i', strtotime($post->deadline)) > $now))
...
@elseif (($post->people <= $post->participate_users()->count()) && (date('Y/n/d G:i', strtotime($post->deadline)) <= $now))
